            ...
            {toasts.map((toast) => (
                ...
                >
                    <span className="flex-shrink-0">
                        ...
                        {toast.type === 'error' && (
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 h-5 text-error">
                    ...
                    <span className="text-sm text-dark-100">{toast.message}</span>
                </div>
            ))}
        </div>
    );
